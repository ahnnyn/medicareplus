...
class mLichLamViec {
    ...
    //             $sqlInsertLich = "INSERT INTO lichlamviec(maBacSi, ngayLamViec, hinhThucKham) VALUES(:maBacSi, :ngayLamViec, :hinhThucKham)";
    ...
    //             $stmtInsert->bindParam(':hinhThucKham', $hinhThucKham, PDO::PARAM_STR);
    //             $stmtInsert->execute();
    ...
    public function themLichLamViecBacSi($maBacSi, $ngayLam, $khungGioList, $hinhThucKham) {
        ...
        try {
            // Kiểm tra xem ngày làm việc đã có trong bảng lichlamviec hay chưa
            $sql = "SELECT maLichLamViec FROM lichlamviec WHERE maBacSi = :maBacSi AND ngayLamViec = :ngayLamViec AND hinhThucKham = :hinhThucKham";
            $stmt = $this->pdo->prepare($sql);
            $stmt->bindParam(':maBacSi', $maBacSi, PDO::PARAM_INT);
            $stmt->bindParam(':ngayLamViec', $ngayLam, PDO::PARAM_STR);
            $stmt->bindParam(':hinhThucKham', $hinhThucKham, PDO::PARAM_STR);
            $stmt->execute();
