            ...
            <div className="col-lg-2 sidebar-left">
                ...
                <img
                  src={
                    dataUpdateDoctor?.hinhAnh
                      ? `${import.meta.env.VITE_BACKEND_URL}/public/bacsi/${
                          dataUpdateDoctor.hinhAnh
                        }`
              ...
              >
                ...
                <button
                  ...
                  type="button"
                >
                  <i className="fa-regular fa-address-card"></i> Thông tin của
                  tôi
                </button>
                <button
                  className="nav-link"
                  ...
                  type="button"
                >
                  <i className="fa-regular fa-calendar"></i> Quản lý lịch làm
                  việc
                </button>
                <button
                  className="nav-link"
