...
const ModalTaoPhieuKham = ({ isModalOpen, setIsModalOpen, editingRecord }) => {
  ...
  useEffect(() => {
    ...
    if (
      (dataPhieuKham &&
        typeof dataPhieuKham === "object" &&
        dataPhieuKham?.maPhieu) ||
      dataPhieuKham?.maDonThuoc
    ) {
      const donThuoc = dataPhieuKham?.maDonThuoc
        ? dataPhieuKham?.danhSachDonThuoc
        : [];
        ...
        <Row gutter={[20, 10]}>
          ...
          <Col span={12} md={12} sm={24} xs={24}>
            <Form.Item
              ...
              name="tienSu"
              rules={[
                { required: true, message: "Vui lòng nhập tiền sử bệnh!" },
              ]}
            >
          ...
          <Col span={12} md={12} sm={24} xs={24}>
            <Form.Item
              ...
              name="chuanDoan"
              rules={[
                { required: true, message: "Vui lòng nhập chuẩn đoán bệnh!" },
              ]}
            >
                          ...
                          <Row gutter={16}>
                            <Col span={6}>
                              <Form.Item
                                ...
                                label="Tên thuốc"
                                rules={[
                                  { required: true, message: "Nhập tên thuốc" },
                                ]}
                              >
